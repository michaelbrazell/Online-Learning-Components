...
/***/ function(module, exports, __webpack_require__) {
	...
	// If skipping main...
	var GroupCard = __webpack_require__(158);
	var GroupProgress = __webpack_require__(159);
	var TrendingProblems = __webpack_require__(160);
	...
	ReactDOM.render(React.createElement(GroupCard, null), document.getElementById('group_card'));
	ReactDOM.render(React.createElement(GroupProgress, null), document.getElementById('group_progress'));
	ReactDOM.render(React.createElement(TrendingProblems, null), document.getElementById('trending_problems'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GroupCard = React.createClass({
	  ...
	  render: function render() {
	    var group = this.state.groups.map(function (group, i) {
	      return React.createElement(
	        'div',
	        { className: 'col-xs-12 col-sm-6 col-md-4', key: 'group' + i },
	        React.createElement(
	          'div',
	          { className: 'panel panel-default group_overview' },
	          React.createElement(
	            'div',
	            { className: 'panel-body' },
	            React.createElement(
	              'h4',
	              { className: 'add_margin_5' },
	              React.createElement(
	                'a',
	                { href: '/matlabcentral/cody/groups/' + group.id },
	                group.name
	              )
	            ),
	            React.createElement(
	              'p',
	              { className: 'add_margin_40' },
	              group.description
	            )
	          ),
	          React.createElement(
	            ...
	            // Problem Count
	            group.solved_count != null ? React.createElement(
	              'p',
	              { className: 'pull-left add_font_color_mediumgray add_margin_0' },
	              group.solved_count,
	              '/',
	              group.number_of_problems,
	              ' Problems'
	            ) : React.createElement(
	              'p',
	              { className: 'pull-left add_font_color_mediumgray add_margin_0' },
	            ...
	            group.solved_count != null ? React.createElement(
	              'div',
	              { className: 'progress add_progress_small add_margin_0' },
	              React.createElement('div', { className: 'progress-bar', role: 'progressbar', 'aria-valuenow': group.percentage_complete / 100, 'aria-valuemin': '0', 'aria-valuemax': '100', style: { width: group.percentage_complete + "%" } })
	    ...
	    return React.createElement(
	      'div',
	      { className: 'row add_equal_heights' },
	      group
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GroupProgress = React.createClass({
	  displayName: 'GroupProgress',
	  ...
	  render: function render() {
	    var group = this.state.groups.map(function (group, i) {
	      return group.solved_count != null ? React.createElement(
	        'div',
	        { className: 'problem_group_progress add_margin_10', key: 'group' + i },
	        React.createElement(
	          'p',
	          { className: 'add_margin_5' },
	          React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'solved-progressbar' },
	          React.createElement(
	            'div',
	            { className: 'progress add_margin_0' },
	            React.createElement(
	              'div',
	              { className: 'progress-bar', role: 'progressbar', 'aria-valuenow': group.percentage_complete / 100, 'aria-valuemin': '0', 'aria-valuemax': '100', style: { width: group.percentage_complete + "%" } },
	              group.percentage_complete
	            )
	          )
	        )
	      ) : React.createElement('span', { className: 'problem_group_progress add_margin_10', key: i });
	    });
	    return React.createElement(
	      'div',
	      null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TrendingProblems = React.createClass({
	  displayName: "TrendingProblems",
	  ...
	  render: function render() {
	    var problem = this.state.problems.map(function (problem, i) {
	      return React.createElement(
	        "tr",
	        { key: i },
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  "h4",
	                  { className: "problem-title add_margin_0" },
	                  React.createElement(
	                    "a",
	                    { href: "/matlabcentral/cody/problems/" + problem.id },
	                    problem.title
	                  )
	                ),
	                React.createElement(
	                  "p",
	                  { className: "add_margin_0" },
	                  React.createElement(
	                    "small",
	                    null,
	                    "Created by ",
	                    React.createElement(
	                      "a",
	                      { href: "/matlabcentral/cody/players/" + problem.created_by_profile_id, title: "title" },
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement(
	                      "a",
	                      { href: "/matlabcentral/cody/players/" + problem.problem_group_id },
	                      problem.problem_group_name
	                    )
	                  )
	                )
	              )
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    "p",
	                    { className: "add_font_color_mediumgray pull-right" },
	                    React.createElement("span", { className: "icon-16 icon-like" }),
	                    problem.likes_count
	                  )
	                ),
	                React.createElement(
	                  ...
	                  React.createElement(
	                    "p",
	                    { className: "add_font_color_mediumgray pull-right" },
	                    React.createElement("span", { className: "icon-16 icon-account" }),
	                    problem.solvers_count
	                  )
	                )
	              )
	            )
	...
	var trendingProblemsData = [{
	  ...
	  "tags": ["sudoku", "solve", "logic", "collection"],
	  "likes_count": 20,
	  "solvers_count": 629
	}, {
	  "id": 68,
	  ...
	  "problem_group_id": 1,
	  "problem_group_name": "Community",
	  "tags": ["cell arrays", "cellfun", "logical indexing"],
	  "likes_count": 0,
	  "solvers_count": 63
	}, {
	  "id": 536,
	  ...
	  "problem_group_id": 1,
	  "problem_group_name": "Community",
	  "tags": ["jerk", "physics", "derivative", "finite difference"],
	  "likes_count": 0,
	  "solvers_count": 23
	}];
