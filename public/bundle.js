...
/***/ function(module, exports, __webpack_require__) {
	...
	var GroupCard = __webpack_require__(155);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var API_URL = 'https://api.myjson.com/bins/r9ifr';
	...
	var GroupCard = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    axios.get(requestUrl, apiConfig).then(function (response) {
	      that.setState({
	  ...
	  render: function render() {
	    var group = this.state.groups.map(function (group, i) {
	      function solvedStatus() {
	        if (group.solved_count != null && group.solved_count < group.problems_count) {
	          ...
	          return React.createElement(
	            ...
	            React.createElement(
	              'p',
	              { className: 'pull-left add_font_color_green add_margin_0' },
	              'Complete'
	            ),
	            React.createElement(
	              'div',
	              { className: 'progress add_progress_small add_margin_0' },
	              React.createElement('div', { className: 'progress-bar add_background_color_green', role: 'progressbar', 'aria-valuenow': group.percentage_complete / 100, 'aria-valuemin': '0', 'aria-valuemax': '100', style: { width: group.percentage_complete + "%" } })
	            )
	          );
	        } else {
	          return React.createElement(
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'panel panel-default add_text_wrapping group_overview' },
	          React.createElement(
	            'div',
